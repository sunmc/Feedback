...
<html class="feedback">
	...
	<body>
		...
		<div class="mui-content" >
			<div class="mui-input-group" style="margin: 5px;">
				<div class="mui-input-row">
					<input id="lsh" type="text" readonly="readonly" value="${da02[0].DJBH}" style="width:100%">
				</div>
			</div>
			<c:forEach items="${da02}" var="item" varStatus="status">
				<div class="mui-card">
		...
		document.getElementById('lczt').addEventListener('tap', function() {
			var urls = '/Feedback/xgxx/da02WorkItem.do?lsh=' + $("#lsh").val();
			mui.openWindow({
				url : urls,
				id : 'lczt',
				show : {
